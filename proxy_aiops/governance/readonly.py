...
Set ``PROXY_READ_ONLY=1`` (or ``true``/``yes``/``on``) and this tool can only
read. Enforcement is deliberately two-layered:

  1. :func:`~proxy_aiops.governance.decorators.governed_tool` refuses any
